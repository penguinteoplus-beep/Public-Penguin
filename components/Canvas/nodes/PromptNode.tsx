  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-bold text-green-300 flex-1">提示词</span>
        <button
      ...
      <div className="p-4">
        {isEditing ? (
          <textarea
            ...
            autoFocus
            className="w-full h-24 bg-black/40 border border-green-500/30 rounded-xl px-3 py-2 text-sm text-white placeholder-gray-500 resize-none focus:outline-none focus:border-green-400 transition-colors"
            placeholder="输入提示词..."
          ...
          <div
            ...
            className="w-full min-h-[80px] bg-black/20 rounded-xl p-3 text-sm text-gray-300 cursor-text hover:bg-black/30 transition-colors border-2 border-dashed border-transparent hover:border-green-500/30"
          >
      ...
      <div className="px-4 pb-3">
        <div className="text-xs text-gray-500 flex items-center justify-between bg-black/20 rounded-lg px-3 py-2">
          ...
          {promptText.length > 0 && (
            <span className="text-green-400">✓ 已输入</span>
          )}
        </div>
      </div>
